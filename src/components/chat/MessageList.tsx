...
// Маппінг технічних назв інструментів на зрозумілі для користувача
const toolDisplayNames: Record<string, string> = {
  str_replace_editor: "Редагування файлу",
  file_manager: "Керування файлами",
};

// Функція для отримання зрозумілої назви інструменту
...
export function MessageList({ messages, isLoading }: MessageListProps) {
  // Пустий стан - показується коли немає повідомлень
  // min-h-[60vh] забезпечує вертикальне центрування елемента
